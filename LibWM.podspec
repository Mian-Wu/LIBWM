...
Pod::Spec.new do |spec|
  ...
  spec.name         = "LibWM"
  spec.version      = "1.0.0"
  spec.summary      = "A short description of LibWM."
  ...
  # Or just: spec.author    = "Mian-Wu"
  # spec.authors            = { "Mian-Wu" => "1256633846@qq.com" }
  # spec.social_media_url   = "https://twitter.com/Mian-Wu"
  ...
  spec.source       = { :git => "https://github.com/Mian-Wu/LIBWM.git", :tag => s.version}
